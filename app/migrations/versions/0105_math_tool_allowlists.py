"""
Migration 0105 — Add search_mathlib and get_lean4_proof_state to math pipeline stage allowlists.
"""

import json

description = "Add search_mathlib and get_lean4_proof_state to math pipeline stage allowlists"
