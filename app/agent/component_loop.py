...
class ComponentLoop:
    ...
    def _build_system_prompt(self) -> str:
        prompt = (
            ...
            "- To undo unintentional file edits: write_git_restore(path) restores a file to HEAD state\n"
            ...
            "- If a tool misbehaves (wrong output, spurious error, missing capability, confusing API): "
            "call report_tool_bug(tool_name, trying_to, expected, actual) BEFORE giving up. "
            "A human operator will read the report and fix the harness. Then try an alternative or submit_work.\n\n"
