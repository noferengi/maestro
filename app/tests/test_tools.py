...
class TestAllowlistSanity:
    def test_all_tool_names_in_registry(self):
        ...
        all_lists = {
            ...
            "FINAL_REVIEW_CODE_QUALITY_TOOLS": FINAL_REVIEW_CODE_QUALITY_TOOLS,
            "FINAL_REVIEW_FUNCTIONAL_TOOLS": FINAL_REVIEW_FUNCTIONAL_TOOLS,
...
VALID_TAGS = ("[READ]", "[RUN", "[WRITE", "[FINISH]")
...
class TestNoShell:
    ...
    def test_not_in_any_allowlist(self, name):
        from app.agent.config import (
            ...
            FINAL_REVIEW_CODE_QUALITY_TOOLS, FINAL_REVIEW_FUNCTIONAL_TOOLS,
